...
- [`android/`](android): All your `android`-specific implementations.
  - [`build.gradle`](android/build.gradle): The gradle build file. This contains four important pieces:
    ...
    3. Adds all Nitrogen files (`apply from: '.../NitroPdfium+autolinking.gradle'`)
  ...
  - [`CMakeLists.txt`](android/CMakeLists.txt): The CMake build file to build C++ code. This contains four important pieces:
    1. Creates a library called `NitroPdfium` (same as in `nitro.json`)
    2. Adds all Nitrogen files (`include(.../NitroPdfium+autolinking.cmake)`)
  ...
  - [`src/main/java/com/margelo/nitro/pdfium/`](android/src/main/java/com/margelo/nitro/pdfium/): All Kotlin implementations.
    - [`NitroPdfiumPackage.java`](android/src/main/java/com/margelo/nitro/pdfium/NitroPdfiumPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
...
- [`NitroPdfium.podspec`](NitroPdfium.podspec): The iOS podspec build file to build the iOS code. This contains three important pieces:
